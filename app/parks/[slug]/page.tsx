      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-8 md:py-12">
        <div className="mb-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b-2 border-black pb-4">
          ...
          <Link
            ...
            className="px-4 py-2 border-2 border-black bg-[var(--accent)] text-white hover:bg-black transition-colors text-sm font-mono uppercase tracking-wider whitespace-nowrap"
          >
            + Add Thing
          </Link>
        </div>
